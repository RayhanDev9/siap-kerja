...
function Button({ children, disabled, to, type, onClick }) {
  const base =
    "inline-block text-sm lg:text-base  bg-blue-600 font-semibold uppercase tracking-wide  transition-colors duration-300 text-white hover:bg-blue-600 focus:bg-blue-600 focus:outline-none disabled:cursor-not-allowed ";
