...
function Button({ children, disabled, to, type, onClick }) {
  const base =
    "inline-block text-sm lg:text-base  bg-blue-600 font-semibold uppercase tracking-wide  transition-colors duration-300 text-white hover:bg-blue-600 focus:bg-blue-600 focus:outline-none disabled:cursor-not-allowed active:bg-blue-800 active:scale-95  hover:bg-blue-700 (";
  ...
  const styles = {
    ...
    generalSecondary:
      " inline-block w-full text-sm sm:text-base lg:text-lg lg:text-base rounded-2xl border   font-semibold uppercase tracking-wide text-stone-400 transition-colors duration-300 hover:bg-blue-600 hover:text-white hover:border-none active:bg-blue-600 active:text-white active:border-none  disabled:cursor-not-allowed px-4 py-3 md:px-6 md:py-3.5 ",
    secondary:
