      ...
      <Listbox value={theme} onChange={setTheme}>
        ...
        */}
        <div className=" w-auto sm:w-36">
          ...
          */}
          <ListboxOptions className="absolute top-full right-0 z-50 mt-2 min-w-[130px]  rounded-2xl border border-slate-200 bg-white/95 p-1.5 shadow-2xl backdrop-blur-md focus:outline-none sm:w-full dark:border-slate-800 dark:bg-[#181818]/95 transition-all duration-500">
