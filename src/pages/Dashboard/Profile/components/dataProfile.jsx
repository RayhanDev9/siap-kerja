const dataProfile = {
  ...
  aiMatchScore: {
    ...
    description: "Sangat cocok untuk peran Senior Product Design.",
    scorePercentage: 92,
  },
  skills: {
    primary: [
  ...
  experience: [
    {
      ...
      description:
        "Memimpin tim desain beranggotakan 5 orang untuk merombak aplikasi mobile utama. Meningkatkan retensi pengguna sebesar 25%.",
      isCurrent: true,
    },
    {
      id: 2,
      role: "Product Designer",
      company: "StartupLokal",
      period: "2018 - 2021",
      description: null,
      isCurrent: false,
    },
