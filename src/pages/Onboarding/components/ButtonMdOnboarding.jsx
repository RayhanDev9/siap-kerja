...
function ButtonMdOnboarding({ button1, button2, to = "", onFinish ,isDisabled = false}) {
  ...
  return (
    <motion.div variants={cardVariants} className="justify-between rounded-2xl shadow-2xl  bg-white p-7 text-center flex  dark:bg-neutral-900 hover:dark:border-white/35">
      ...
      <div className="inline-block">
        <Button type="generalPrimary" disabled={isDisabled}  onClick={onFinish} to={onFinish ? "" : to} >
          {button2}
        </Button>
      </div>
    </motion.div>
